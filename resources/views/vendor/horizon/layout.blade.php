{{--
    Copy of `vendor/laravel/horizon/resources/views/layout.blade.php` with the
    two `fonts.bunny.net` tags removed: the dashboard is not allowed to fetch a
    webfont from a third party on a self-hosted instance, and `style-src 'self'`
    blocks it anyway (see App\Http\Middleware\SecurityHeaders). Horizon's own
    CSS falls back to the system font stack.

    Re-copy this file, minus those two tags, when upgrading Horizon.
--}}
<!DOCTYPE html>
<html lang="en">
<head>
