...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Horizon Dashboard Users
    |--------------------------------------------------------------------------
    |
    | Comma-separated email addresses that may view Horizon outside local
    | environments. Leave empty to keep the production dashboard closed.
    |
    */
    ...
    */
    ...
    'waits' => [
        'redis:'.env('REDIS_QUEUE', 'default') => (int) env('HORIZON_WAIT_THRESHOLD', 60),
    ],
    ...
    'defaults' => [
        'supervisor-1' => [
            ...
            'queue' => array_values(array_filter(array_map(
                ...
                explode(',', (string) env('HORIZON_QUEUES', env('REDIS_QUEUE', 'default'))),
            ))),
            'balance' => 'auto',
